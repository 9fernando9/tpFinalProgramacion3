...
export const validarCreate = [
    ...
    check('importe','El importe es obligatorio').not().isEmpty().isFloat().withMessage('El importe debe ser numérico'),
...
export const validarUpdate = [
    ...
    check('importe').optional({ checkFalsy: true }).not().isEmpty().withMessage('El importe no puede estar vacío').isFloat().withMessage('El importe debe ser numérico'),
    (req, res, next) => validarCampos(req, res, next)
];