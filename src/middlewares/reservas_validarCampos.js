...
export const validarCreate = [
    ...
    check('importe_salon','El importe del salón es obligatorio').isNumeric(),
    check('importe_total','El importe total es obligatorio').isNumeric(),
...
export const validarUpdate = [
    ...
    check('importe_salon').optional({ checkFalsy: true }).isNumeric().withMessage('El importe del salón debe ser numérico'),
    check('importe_total').optional({ checkFalsy: true }).isNumeric().withMessage('El importe total debe ser numérico'),
    (req, res, next) => validarCampos(req, res, next)
];